...
{
    public abstract class SqlServerDataManager<TContext> : DbDataManager where TContext : SqlServerDataContext
    {
        public SqlServerDataManager(IDataAccessConfiguration configuration) : base(configuration)
        {
        }
